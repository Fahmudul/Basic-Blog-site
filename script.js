...
function createPost(postInfo) {
  ...
  for (let post of postInfo) {
    ...
    if (post.isActive) {
      postItem.innerHTML = `
          <div class="flex lg:flex-row flex-col gap-x-5 mb-4 card-bg p-10">
          ...
          <p><i class="fa-regular fa-message" style="color: #b0b2b5;"></i> ${post.comment_count}</p>
                  ...
                  <div id="${post.id}" class="w-10 bg-[#10B981] flex justify-center items-center rounded-3xl">
      ...
      if (newnews.isActive) {
        postItem.innerHTML = `
          ...
          <p><i class="fa-regular fa-message" style="color: #b0b2b5;"></i> ${newnews.comment_count}</p>
                  ...
                  <div id="${newnews.id}" class="w-10 bg-[#10B981] flex justify-center items-center rounded-3xl">
                  <img class="h-6  " src="mail.png" alt="mail">
                  </div>
                  </div>
                  </div>
